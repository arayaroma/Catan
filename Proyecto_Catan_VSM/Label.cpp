...
Label::Label(const char* text, int x_position, int y_position, unsigned int font_size) {
	this->text = text;
...
void Label::set_font_size(unsigned int font_size) { this->font_size = font_size; }
